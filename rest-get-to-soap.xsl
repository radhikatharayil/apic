    ...
    <xsl:template match="/">
        ...
        <xsl:choose>
            <xsl:when test="$url = '/projects'">
                ...
                <dp:set-variable name="'var://context/rest/soap-action'" value="'http://soap.example.com/demoService/listProjects'"/>
            ...
            <xsl:otherwise>
                ...
                <dp:set-variable name="'var://context/rest/soap-action'" value="'http://soap.example.com/demoService/getProject'"/>
